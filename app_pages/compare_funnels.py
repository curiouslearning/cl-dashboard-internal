...
if (
    ...
    metrics_home_A = get_engagement_metrics_for_cohort(user_cohort_dfA)
    metrics_home_B = get_engagement_metrics_for_cohort(user_cohort_dfB)
    metrics_home_C = get_engagement_metrics_for_cohort(user_cohort_dfC)
